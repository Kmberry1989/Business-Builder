...
const defaultPresets = {
    "Rochelle Elaine Berry": {
        ...
        cardStyle: { ...initialCardStyle, fontFamily: "'Playfair Display', serif", primaryColor: "#db2777", secondaryColor: "#52525b", qrCode: { enabled: false, side: 'back', position: 'bottom-right', size: 80 },
            elements: { ...initialCardStyle.elements, tagline: {side: 'front'} },
            elementPositions: { 
                name: { x: 50, y: 30 }, title: { x: 50, y: 42 }, company: { x: 50, y: 54 }, 
                phone: { x: 50, y: 66 }, email: { x: 50, y: 78 }, website: { x: 50, y: 90 },
                tagline: { x: 50, y: 95}, monogram: {x: 50, y: 50}, qrcode: { x: 85, y: 85 }, headshot: { x: 15, y: 20 },
            }
        },
    }
};
